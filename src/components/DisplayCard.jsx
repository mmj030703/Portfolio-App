...
function DisplayCard({ title, imgSrc }) {
    return (
        <div className="w-full h-fit border-2 border-white/30 rounded-[30px] pt-5 text-black bg-white/20 backdrop-blur-md relative before:absolute after:absolute before:w-[95%] after:w-[95%] before:h-[50%] after:h-[50%] before:bg-white/20 after:bg-white/30 before:top-[10rem] after:top-[8.7rem] before:left-[2.5%] after:left-[2.5%] before:rounded-3xl after:rounded-3xl after:backdrop-blur-md before:backdrop-blur-md">
            ...
            <div className="flex items-end mt-24">
                <div className="z-50 w-max bg-white p-8 rounded-[30px]">
                    <img src={imgSrc} alt={title + 'Image'} className="z-50 w-[300px] h-72 rounded-3xl shadow-xl" />
                </div>
            </div>
