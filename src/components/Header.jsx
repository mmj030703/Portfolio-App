    ...
    <header>
      <Container>
        <nav className="flex justify-center font-poppins">
          <ul className="fixed z-10 mt-4 w-fit px-1 bg-zinc-900 text-white py-2 rounded-full flex justify-center mx-auto before before:absolute before:w-[2px] before:h-6 before:bg-zinc-700 before:-top-6 before:left-14 after:absolute after:h-6 after:w-[2px] after:bg-zinc-700 after:-top-6 after:right-14">
            <div className="flex">
